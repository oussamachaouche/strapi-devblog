...
export interface ApiCompanyInfoCompanyInfo extends Schema.SingleType {
  ...
  attributes: {
    ...
    companyAdresse: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    feateredCourse: Attribute.Component<'layout.featered-course'>;
    postsSelection: Attribute.Component<'blog.posts-selection'>;
    DynamicHomeSection: Attribute.DynamicZone<
      ['layout.news-latter-form', 'layout.mission']
    >;
...
export interface ApiPagesInfoPagesInfo extends Schema.SingleType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::pages-info.pages-info', 'title'> &
      Attribute.Required;
    pageInfo: Attribute.Component<'layout.page-info'>;
    excludedcourses: Attribute.Relation<
      'api::pages-info.pages-info',
      'oneToMany',
      'api::course.course'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiPostCategory extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    slug: Attribute.UID<'api::post.category', 'name'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::post.category',
...
export interface ApiSeoConfigSeoConfig extends Schema.SingleType {
  ...
  attributes: {
    seoDefault: Attribute.Component<'seo.seo-information'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::pages-info.pages-info': ApiPagesInfoPagesInfo;
      'api::post.category': ApiPostCategory;
